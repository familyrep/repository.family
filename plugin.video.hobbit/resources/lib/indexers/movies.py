...
class movies:
        def __init__(self):
                ...
                if self.tmdb_key == '' or self.tmdb_key == None:
                        self.tmdb_key         = base64.b64decode('MDUyNTVhYTY4ZGY4MjcwYmYwMjhmMTgyYjAxYWQ3OTk=')
        ...
        def movieDirectory(self, items):
                ...
                for i in items:
                        try:
                                ...
                                if "tt" in imdb                     : sysmetalliq = "plugin://plugin.video.metalliq/movies/add_to_library_parsed/imdb/%s/direct.hobbit.q" % imdb
                                elif not tmdb == "0" or tmdb == None: sysmetalliq = "plugin://plugin.video.metalliq/movies/add_to_library_parsed/tmdb/%s/direct.hobbit.q" % tmdb
                                else                                : sysmetalliq = "0"
