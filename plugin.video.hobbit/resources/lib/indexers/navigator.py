...
sysaddon         = base64.b64decode('cGx1Z2luOi8vcGx1Z2luLnZpZGVvLmhvYmJpdC8=')
...
class navigator:
        def root(self):
                ...
                #self.addDirectoryItem('My Hobbit',       'lists_navigator',      'mymovies.png',      'DefaultRecentlyAddedMovies.png')
                ...
                if not control.setting('lists.widget') == '0':
                        self.addDirectoryItem('Trakt MY Movies', 'soullessNavigator',    'trakt.png',      'DefaultVideoPlaylists.png')
                        self.addDirectoryItem('Trakt MY TV Shows',     'tvshowstNavigator',    'trakt.png',     'DefaultVideoPlaylists.png')
...
#		self.addDirectoryItem('Trending',          'movies&url=trending',   'trending.png',      'DefaultRecentlyAddedMovies.png')
        ...
        def tools(self):
                ...
                self.addDirectoryItem('[B]Hobbit[/B]: Views', 'viewsNavigator', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem('[B]Hobbit[/B]: Clear Providers', 'clearSources', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem('[B]Hobbit[/B]: Clear Cache', 'clearCache', 'tools.png', 'DefaultAddonProgram.png')
                ...
                self.addDirectoryItem('[B]Hobbit[/B]: Clear Progress Database', 'clearProgress', 'tools.png', 'DefaultAddonProgram.png')
                self.endDirectory()
